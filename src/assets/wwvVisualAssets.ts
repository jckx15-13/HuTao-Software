...
const ORBITAL_ICON_ROOT = `${import.meta.env.BASE_URL}wwv-assets/orbital`;
...
export const WWV_SOURCE_PUBLIC_ASSETS: WwvSourcePublicAsset[] = [
  {
    path: 'ads.txt',
    url: sourcePublicPath('ads.txt'),
    sourcePath: `${WWV_SOURCE_ROOT}/ads.txt`,
    category: 'site-meta'
  },
  {
    path: 'airplane.zip',
    url: sourcePublicPath('airplane.zip'),
    sourcePath: `${WWV_SOURCE_ROOT}/airplane.zip`,
    category: 'aircraft'
  },
  {
    path: 'airplane/license.txt',
    url: sourcePublicPath('airplane/license.txt'),
    sourcePath: `${WWV_SOURCE_ROOT}/airplane/license.txt`,
    category: 'aircraft'
  },
  {
    path: 'airplane/scene.bin',
    url: sourcePublicPath('airplane/scene.bin'),
    sourcePath: `${WWV_SOURCE_ROOT}/airplane/scene.bin`,
    category: 'aircraft'
  },
  {
    path: 'airplane/scene.gltf',
    url: sourcePublicPath('airplane/scene.gltf'),
    sourcePath: `${WWV_SOURCE_ROOT}/airplane/scene.gltf`,
    category: 'aircraft'
  },
  {
    path: 'aircraft-samples.geojson',
    url: sourcePublicPath('aircraft-samples.geojson'),
    sourcePath: `${WWV_SOURCE_ROOT}/aircraft-samples.geojson`,
    category: 'geojson-data'
  },
  {
    path: 'borders.geojson',
    url: sourcePublicPath('borders.geojson'),
    sourcePath: `${WWV_SOURCE_ROOT}/borders.geojson`,
    category: 'geojson-data'
  },
  {
    path: 'satellites.json',
    url: sourcePublicPath('satellites.json'),
    sourcePath: `${WWV_SOURCE_ROOT}/satellites.json`,
    category: 'geojson-data'
  },
  {
    ...
    securityNote:
      'Served copy removes raw camera stream and thumbnail URLs; only location data and source-presence flags remain.'
  },
  {
  ...
  {
    path: 'e2e-fixtures/e2e-mock-bottom-panel.js',
    url: sourcePublicPath('e2e-fixtures/e2e-mock-bottom-panel.js'),
    sourcePath: `${WWV_SOURCE_ROOT}/e2e-fixtures/e2e-mock-bottom-panel.js`,
    category: 'plugin-fixture'
  },
  {
    path: 'e2e-fixtures/manifest.json',
    url: sourcePublicPath('e2e-fixtures/manifest.json'),
    sourcePath: `${WWV_SOURCE_ROOT}/e2e-fixtures/manifest.json`,
    category: 'plugin-fixture'
  },
  {
    path: 'e2e-fixtures/mock-plugin.js',
    url: sourcePublicPath('e2e-fixtures/mock-plugin.js'),
    sourcePath: `${WWV_SOURCE_ROOT}/e2e-fixtures/mock-plugin.js`,
    category: 'plugin-fixture'
  },
  {
    path: 'favicon.svg',
    url: sourcePublicPath('favicon.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/favicon.svg`,
    category: 'brand'
  },
  {
    path: 'logo/app-icon-inverted.png',
    url: sourcePublicPath('logo/app-icon-inverted.png'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/app-icon-inverted.png`,
    category: 'brand'
  },
  {
    path: 'logo/favicon-inverted.svg',
    url: sourcePublicPath('logo/favicon-inverted.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/favicon-inverted.svg`,
    category: 'brand'
  },
  {
    path: 'logo/favicon.svg',
    url: sourcePublicPath('logo/favicon.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/favicon.svg`,
    category: 'brand'
  },
  {
    path: 'logo/logo-full.png',
    url: sourcePublicPath('logo/logo-full.png'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/logo-full.png`,
    category: 'brand'
  },
  {
    path: 'logo/logo-icon.jpg',
    url: sourcePublicPath('logo/logo-icon.jpg'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/logo-icon.jpg`,
    category: 'brand'
  },
  {
    path: 'logo/logo-icon.png',
    url: sourcePublicPath('logo/logo-icon.png'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/logo-icon.png`,
    category: 'brand'
  },
  {
    path: 'logo/logo-icon.svg',
    url: sourcePublicPath('logo/logo-icon.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/logo/logo-icon.svg`,
    category: 'brand'
  },
  {
    path: 'military_bases.geojson',
    url: sourcePublicPath('military_bases.geojson'),
    sourcePath: `${WWV_SOURCE_ROOT}/military_bases.geojson`,
    category: 'geojson-data'
  },
  {
    path: 'military-plane-icon.svg',
    url: sourcePublicPath('military-plane-icon.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/military-plane-icon.svg`,
    category: 'aircraft'
  },
  {
    path: 'plane-icon.svg',
    url: sourcePublicPath('plane-icon.svg'),
    sourcePath: `${WWV_SOURCE_ROOT}/plane-icon.svg`,
    category: 'aircraft'
  },
  {
...
export const WWV_VISUAL_ASSETS: WwvVisualAsset[] = [
  ...
  },
  {
    ...
    intendedUse:
      'Derived orbital marker shaped for space-station entities because WWV has no satellite-specific source asset.'
  },
  {
