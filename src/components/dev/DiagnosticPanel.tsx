...
export default function DiagnosticPanel() {
  ...
  return (
    <div className="fixed right-[max(1rem,env(safe-area-inset-right))] top-16 z-popover w-[min(560px,calc(100vw-1.5rem))] max-h-[min(82vh,40rem)] overflow-auto glass-panel border border-white/5 p-3 text-white pointer-events-auto">
