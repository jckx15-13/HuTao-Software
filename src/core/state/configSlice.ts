...
export const createConfigSlice: StateCreator<AppStore, [], [], ConfigSlice> = (set) => ({
    ...
    mapConfig: {
        ...
        baseLayerId: (typeof window !== "undefined" && window.localStorage && typeof window.localStorage.getItem === "function") ? (localStorage.getItem("wwv_map_layer") || "arcgis-world") : "arcgis-world",
        fallbackLayerId: "osm",
        sceneMode: 3,
